...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug', # todo dangerous on production
...
# default settings for sqlite3 if you wish to use sqlite3 just delete DATABASE_URL
# DATABASES = {
#     'default': {
...
# 'users.serializers.UserSettingsSerializer'
